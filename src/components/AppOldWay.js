...
class AppOldWay extends React.Component{
    ...
    render(){
        ...
        <div>
            ...
            {petElementArray}
            <input value={this.state.petName} onChange={this.handleNameInput} type="text" placeholder="Pet Name"/>
            <input value={this.state.petBreed} onChange={this.handleBreedInput} type="text" placeholder="Pet Breed"></input>
            <input value={this.state.petAge} onChange={this.handleAgeInput} type="text" placeholder="Pet Age"></input>
